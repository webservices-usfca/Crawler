# This is for the situation that we want the certain url contains on the link
# the url we get is most important and unique
# url cannot be unique, link only identify their origin.
# change keyword variable to get the url
